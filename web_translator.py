        ...
        try:
            with st.spinner("🚀 Sending..."):
                ...
                if eng_meaning:
                    ...
                    # Convert English meaning to partner's language
                    final_msg = eng_meaning
